...
def make_quad(grad, quad, x_thrd, y_thrd, height, width): 
     ...
     if quad == 1: 
         ...
         quad1 = x_thrd+width
         quad2 = (height+50) - y_thrd
         
     elif quad == 3: 
         quad1 = (width+50) - x_thrd
         quad2 = (height+50) - y_thrd
...
def create_landscape(height, width):
    ...
    '''
    super_landscape = {}
    for  x_split in range(0,width, 50):
        for y_split in range(0, height, 50):
            ...
            for n in [1]: 
                quad = make_quad(grad, n, x_thrd-6, y_thrd-7, x_split, y_split)
                landscape = {**landscape, **quad}

            for n in [2]: 
                quad = make_quad(grad, n, x_thrd-6, y_thrd-6, x_split, y_split)
                landscape = {**landscape, **quad}
            ...
            for n in [4]: 
                ...
                landscape = {**landscape, **quad}
            #print (len(landscape))    
            super_landscape = {**super_landscape, **landscape}
    
    return super_landscape