...
if __name__ == '__main__':
    for run in range(10):   
        ...
        test = NetScape(height = 250, width = 250, initial_population = 50000, regrow = 1,\
                        Moore = False)
        ...
        d_mesa = Space_Distribute(test, step_finish,\
                            split = 4)#, resolver = resolver) 
    
        #run the program, pass in the steps
        results = d_mesa.distro_geo(250)
...
#print (survivors)
#print (total_time)
#pickle.dump(price_df, open("multi_total_price_2_72000_v.p", "wb"))
pickle.dump(survivors, open( "multi_sur_4_50000_v.p", "wb" ))
pickle.dump(step_time, open("multi_step_time_4_50000_v.p", "wb")) 
pickle.dump(total_time, open("multi_total_time_4_50000_v.p", "wb")) 
